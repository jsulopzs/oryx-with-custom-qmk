...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_Z,           MT(MOD_LCTL, KC_X),KC_C,           MT(MOD_LGUI, KC_V),ALL_T(KC_B),                                    KC_N,           MT(MOD_RGUI, KC_M),KC_COMMA,       MT(MOD_RCTL, KC_DOT),KC_UNDS,        KC_SLASH,       
                                                    LT(4,KC_ENTER), KC_TRANSPARENT,                                 MEH_T(KC_ESCAPE),ALL_T(KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
