...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_TAB,         KC_Z,           MT(MOD_LCTL, KC_X),KC_C,           MT(MOD_LGUI, KC_V),KC_B,                                           KC_N,           MT(MOD_RGUI, KC_M),KC_COMMA,       MT(MOD_RCTL, KC_DOT),KC_UNDS,        QK_AREP, 
                                                    LT(4,KC_ENTER), ALL_T(KC_ESCAPE),                                QK_REP, KC_SPACE
  ),
  [1] = LAYOUT_voyager(
...
const uint16_t PROGMEM combo2[] = { MT(MOD_LALT, KC_A), MT(MOD_RALT, KC_EQUAL), COMBO_END};
const uint16_t PROGMEM combo3[] = { MT(MOD_LALT, KC_A), MEH_T(KC_QUOTE), COMBO_END};
